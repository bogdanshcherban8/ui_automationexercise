...
the [Automation Exercise site](https://www.automationexercise.com/). The
tests are written using **Python**, **Pytest**, **Allure** and **Playwright**.

## Project Overview

The goal of this project is to automate the testing of the automation exercise site. The automated tests verify various
...
```bash
git https://github.com/bogdanshcherban8/ui_automationexercise.git
cd ui_automationexercise
```
